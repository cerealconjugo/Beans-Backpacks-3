...
public class BackpackModel<T extends Entity>
	...
	public void renderMask(PoseStack matrices, VertexConsumer vertexConsumer, int light, int overlay, int color) {
		mask.render(matrices, vertexConsumer, light, overlay, color);
	}
