...
public class BackpackCapeModel<T extends Player> extends EntityModel<T> {
	...
	@Override public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int i, int i1, int i2) {
		cape.render(poseStack, vertexConsumer, i, i1, i2);
	}
}